    ...
    const fetchData = async () => {
      ...
      try {
        const [usersRes, claimsRes, policiesRes, hrsRes, agentsRes] = await Promise.all([
          axios.get("https://insurai-backend-production.up.railway.app/auth/employees", { headers: { Authorization: `Bearer ${token}` } }),
          axios.get("https://insurai-backend-production.up.railway.app/admin/claims", { headers: { Authorization: `Bearer ${token}` } }),
          axios.get("https://insurai-backend-production.up.railway.app/admin/policies", { headers: { Authorization: `Bearer ${token}` } }),
          axios.get("https://insurai-backend-production.up.railway.app/hr", { headers: { Authorization: `Bearer ${token}` } }),
          axios.get("https://insurai-backend-production.up.railway.app/agent", { headers: { Authorization: `Bearer ${token}` } }),
        ]);
