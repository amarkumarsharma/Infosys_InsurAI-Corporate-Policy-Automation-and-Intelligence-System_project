...
export default function AgentDashboard() {
  ...
  useEffect(() => {
    ...
    if (storedAgentId && storedAgentName) {
      ...
      // Fetch availability
      axios.get(`https://insurai-backend-production.up.railway.app/agent/${id}/availability`, axiosConfig)
        .then(res => {
      ...
      let employeeMap = {};
      axios.get("https://insurai-backend-production.up.railway.app/auth/employees", axiosConfig)
        .then(empRes => {
          ...
          // Fetch all queries
          axios.get(`https://insurai-backend-production.up.railway.app/agent/queries/all/${id}`, axiosConfig)
            .then(res => {
              if (res.data) {
  ...
  const toggleAvailability = async () => {
    try {
      ...
      await axios.post("https://insurai-backend-production.up.railway.app/agent/availability", {
        agentId,
        available: newStatus,
      ...
      const res = await axios.get(`https://insurai-backend-production.up.railway.app/agent/${agentId}/availability`, axiosConfig);
