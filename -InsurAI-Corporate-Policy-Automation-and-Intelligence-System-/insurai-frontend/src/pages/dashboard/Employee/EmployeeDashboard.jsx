...
export default function EmployeeDashboard() {
  ...
  const fetchLoggedInEmployee = async (token) => {
    try {
      const response = await axios.get("http://https://ingenious-surprise-production.up.railway.app/auth/employees", {
  ...
  const fetchEmployeeData = async (token) => {
    ...
    try {
      const response = await axios.get("http://https://ingenious-surprise-production.up.railway.app/employee/policies", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchEmployeeClaims = async (token) => {
    ...
    try {
      const response = await axios.get("http://https://ingenious-surprise-production.up.railway.app/employee/claims", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchAgents = async (token) => {
    try {
      const response = await axios.get("http://https://ingenious-surprise-production.up.railway.app/agent/availability/all", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const fetchEmployeeQueries = async (token) => {
    ...
    try {
      const response = await axios.get("http://https://ingenious-surprise-production.up.railway.app/employee/queries", {
        headers: { Authorization: `Bearer ${token}` }
      });
  ...
  const handleQuerySubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `http://https://ingenious-surprise-production.up.railway.app/employee/queries?agentId=${selectedAgentId}&queryText=${encodeURIComponent(newQuery.queryText)}&policyName=${encodeURIComponent(policyName)}&claimType=${encodeURIComponent(newQuery.claimType)}`,
        null,
        {
          headers: {
